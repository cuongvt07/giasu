            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 sm:p-8">
                    ...
                    <div class="prose prose-indigo max-w-none">
                        ...
                        <ul class="list-disc ml-6 mb-4">
                            <li><strong>Giữa gia sư và học sinh:</strong> Khi học sinh Kết nối gia sư hỗ trợ nhanh với gia sư, chúng tôi sẽ chia sẻ thông tin liên hệ và các chi tiết cần thiết khác.</li>
