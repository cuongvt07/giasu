...
<div class="bg-gray-50 min-h-screen"
    x-data="{
        ...
        applyToJob() {
            ...
            fetch('/tutor/apply', {
                ...
                body: JSON.stringify({ job_id: this.selectedJob.id }),
            })
            .then(res => {
                ...
                <form action="{{ route('tutors.jobs.post') }}" method="GET" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="subject" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <select name="class_level_id" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <select name="mode" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option value="">Tất cả</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="sort_by" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div class="flex justify-end space-x-4">
                        <a href="{{ route('tutors.jobs.post') }}" class="px-6 py-2 rounded-lg border bg-white text-gray-700 shadow hover:bg-gray-50">
                            Đặt lại
                        </a>
                        <button type="submit" class="px-6 py-2 rounded-lg bg-indigo-600 text-white shadow hover:bg-indigo-700">
                            Tìm kiếm
                        </button>
                    </div>
                </form>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition p-6 flex flex-col">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="px-3 py-1 text-xs rounded-full {{ $post->mode == 'online' ? 'bg-blue-50 text-blue-600' : 'bg-green-50 text-green-600' }}">
                        {{ ucfirst($post->mode) }}
                    </span>
                </div>
                ...
                <dl class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-gray-700 flex-grow">
                    ...
                    <div>
                        ...
                        <dd>{{ number_format($post->budget_min) }} - {{ number_format($post->budget_max) }} / {{ $post->budget_unit }}</dd>
                    </div>
                    @if($post->deadline_at)
                    <div>
                ...
                <div class="mt-6 flex justify-between items-center border-t pt-4 gap-3">
                    <button @click='selectedJob = @json($post)'
                    ...
                    @auth
                    <button
                        @click='selectedJob = @json($post); applyToJob()'
                        ...
                        <span x-show="!isApplying">Ứng tuyển</span>
                        <span x-show="isApplying" class="inline-flex items-center gap-1">
    ...
    <div
        ...
        <div
            ...
            @click.self="selectedJob = null"></div>
        ...
        <div
            ...
            <div class="sticky top-0 flex items-center justify-between border-b bg-white/80 px-6 py-4 backdrop-blur">
                ...
                <button @click="selectedJob = null" class="h-8 w-8 rounded-full hover:bg-gray-100 flex items-center justify-center text-gray-600">
            ...
            <div class="px-6 py-5 space-y-4">
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <dd x-text="selectedJob.budget_min + ' - ' + selectedJob.budget_max + ' / ' + selectedJob.budget_unit"></dd>
                    </div>
                    <div>
