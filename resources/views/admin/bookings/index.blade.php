...
<div class="bg-white shadow rounded-lg">
    <div class="p-6">
        <h2 class="text-xl font-semibold text-gray-900">Danh Sách Kết nối gia sư hỗ trợ nhanh</h2>
    </div>

    <!-- Kết nối gia sư hỗ trợ nhanh chờ xác nhận -->
    ...
    <!-- Kết nối gia sư hỗ trợ nhanh đã xác nhận -->
    <div class="p-6 border-t border-gray-200">
    ...
    <!-- Kết nối gia sư hỗ trợ nhanh đang chờ hoàn thành -->
    <div class="p-6 border-t border-gray-200">
    ...
    <!-- Kết nối gia sư hỗ trợ nhanh đã hoàn thành -->
    <div class="p-6 border-t border-gray-200">
