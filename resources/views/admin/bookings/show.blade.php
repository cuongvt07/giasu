...
@section('page_title', 'Chi Tiết Kết nối gia sư hỗ trợ nhanh')

@section('content')
<div class="max-w-5xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Chi Tiết Kết nối gia sư hỗ trợ nhanh #{{ $booking->id }}</h2>
            <div class="flex space-x-3">
                ...
                <form action="{{ route('admin.bookings.destroy', $booking) }}" method="POST" class="inline-block">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Bạn có chắc chắn muốn xóa Kết nối gia sư hỗ trợ nhanh này?')" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
            ...
            <div class="mb-8">
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-500">Thời gian Kết nối gia sư hỗ trợ nhanh</h4>
