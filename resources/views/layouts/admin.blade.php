    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg">
            ...
            <nav class="mt-5 px-2">
                ...
                <a href="{{ route('admin.jobs.index') }}" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-gray-900 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-100 transition ease-in-out duration-150 {{ request()->routeIs('admin.earnings.*') ? 'bg-gray-100' : '' }}">
                    <svg class="text-gray-400 group-hover:text-gray-300 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    Đăng tin 
