            ...
            <div>
                ...
                @else
                    <div class="text-center py-6 bg-gray-50 rounded-lg">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Chưa có quản lý lịch rảnh</h3>
                        <p class="mt-1 text-sm text-gray-500">Gia sư chưa cập nhật quản lý lịch rảnh sắp tới.</p>
                    </div>
                @endif
