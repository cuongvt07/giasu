            ...
            @if($availabilities->isEmpty())
                <div class="text-center py-12 bg-gray-50 rounded-lg m-6">
                    ...
                    <div class="mt-6 flex justify-center gap-3">
                        ...
                        <!-- <a href="{{ route('tutor.availability.quick-store') }}" class="inline-flex items-center px-5 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 transform hover:scale-105">
