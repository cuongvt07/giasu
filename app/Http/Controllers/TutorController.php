...
class TutorController extends Controller
{
    ...
    public function show(Tutor $tutor)
    {
        ...
        // Lấy quản lý lịch rảnh của gia sư (cả quản lý lịch rảnh cụ thể và lịch lặp lại)
    ...
    public function book(Request $request, Tutor $tutor)
    {
        ...
        return back()->with('success', 'Yêu cầu Kết nối gia sư hỗ trợ nhanh của bạn đã được gửi đến gia sư.');
    }
